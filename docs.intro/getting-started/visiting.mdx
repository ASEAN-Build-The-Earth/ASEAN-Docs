...
<table><td style={{paddingLeft:"2rem"}}><b><i>Table of Contents</i></b><TOCInline toc={toc} maxHeadingLevel="4"/></td></table>
...
### To visit what we've built
  ...
  >
  > <Styling.MinecraftWindow width="fit-content"><img src={require('../../static/img/docs/visiting/quick_warp.gif').default} width="500rem" alt="Guide Image"/></Styling.MinecraftWindow>
