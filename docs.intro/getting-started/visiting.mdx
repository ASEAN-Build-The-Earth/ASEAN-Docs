...
import IMG_GuickWarp from "@site/static/img/docs/intro/visiting/quick_warp.gif";
...
This is because we have a mod called Cubic Chunks in our master server that extends the world height to infinity, hence bedrock edition is not supported.
...
### To visit what we have built
  ...
  >
  > <MinecraftWindow useDropdown="true" maxWidth="600px"><Img src={IMG_GuickWarp} width="600" height="470" alt="Guide Image"/></MinecraftWindow>
