...
This is because in our master server, we have a mod (Cubic Chunks) that extends the world height making bedrock edition unsupported.
...
### To visit what we've built
  ...
  >
  > <Styling.MinecraftWindow useDropdown="true" width="fit-content"><img src={require('@site/static/img/docs/visiting/quick_warp.gif').default} width="500rem" alt="Guide Image"/></Styling.MinecraftWindow>
