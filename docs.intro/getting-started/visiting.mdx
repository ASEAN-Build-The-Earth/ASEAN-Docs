...
Because the mod we talked above, it affects all minecraft versisons that are not 1.12.2<br/>
If you continue to visit with those newer versions you may get a long rendering times and wierd chunk loading in you. 
