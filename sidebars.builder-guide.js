...
module.exports = {
  docs_builderGuide: [
    ...
    /* "Building In BuildTheEarth" Category */
    {
      ...
      items: [
        {
          /* "Basic Building" Category */ type: "category",
        ...
        {
          /* "Advance Building" Category */ type: "category",
        ...
        {
          /* "Building HDBs in Singapore" Category */ type: "category",
          label: "Building HDBs in Singapore",
          link: {
            type: "generated-index",
          },
          items: [
            /* Building HDBs in Singapore Documents */
            {
              type: "doc",
              label: "Terminology",
              id: "building/building-hdbs/terminology",
            },
            {
              type: "doc",
              label: "Setup",
              id: "building/building-hdbs/setup",
            },
            {
              type: "doc",
              label: "Types of units",
              id: "building/building-hdbs/types-of-units",
            },
            {
              type: "doc",
              label: "Patterns",
              id: "building/building-hdbs/patterns",
            },
          ],
        },
      ],
    ...
    {
      /* "World Edit" Category */ type: "category",
      label: "WorldEdit",
      link: {
        type: "doc",
      ...
      items: [
        /* World Edit Documents */
        {
          ...
          items: ["worldedit/basic/blocks-ids", "worldedit/basic/pline"],
        },
        {
          type: "category",
